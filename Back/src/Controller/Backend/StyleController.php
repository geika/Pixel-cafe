...
class StyleController extends AbstractController
{
    ...
    {
        return $this->render('backend/style/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('backend/style/new.html.twig', [
            'style' => $style,
    ...
    {
        return $this->render('backend/style/show.html.twig', [
            'style' => $style,
        ]);
    }
    ...
    public function edit(Request $request, Style $style): Response
    {
        ...
        return $this->render('backend/style/edit.html.twig', [
            'style' => $style,
            'form' => $form->createView(),
        ]);
    }
