...
class RateController extends AbstractController
{
    ...
    {
        return $this->render('backend/rate/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('backend/rate/new.html.twig', [
            'rate' => $rate,
    ...
    {
        return $this->render('backend/rate/show.html.twig', [
            'rate' => $rate,
        ]);
    }
    ...
    public function edit(Request $request, Rate $rate): Response
    {
        ...
        return $this->render('backend/rate/edit.html.twig', [
            'rate' => $rate,
            'form' => $form->createView(),
        ]);
    }
